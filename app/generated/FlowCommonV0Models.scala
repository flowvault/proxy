 ...
 * apibuilder:0.12.16 https://app.apibuilder.io/flow/common/0.3.28/play_2_x_json
 */
      ...
      def reads(js: play.api.libs.json.JsValue): play.api.libs.json.JsResult[ExpandableOrganization] = {
        (js \ "discriminator").validateOpt[String] match {
          ...
          case play.api.libs.json.JsSuccess(discriminator, _) => {
            discriminator match {
              case Some("organization") => js.validate[io.flow.common.v0.models.Organization]
              case Some("organization_reference") => js.validate[io.flow.common.v0.models.OrganizationReference]
              case Some(other) => play.api.libs.json.JsSuccess(io.flow.common.v0.models.ExpandableOrganizationUndefinedType(other))
              case None => sys.error("Union[ExpandableOrganization] requires a discriminator named 'discriminator' - this field was not found in the Json Value")
            }
          }
        }
      }
    ...
    implicit def jsonReadsCommonExpandableUser: play.api.libs.json.Reads[ExpandableUser] = new play.api.libs.json.Reads[ExpandableUser] {
      def reads(js: play.api.libs.json.JsValue): play.api.libs.json.JsResult[ExpandableUser] = {
        (js \ "discriminator").validateOpt[String] match {
          ...
          case play.api.libs.json.JsSuccess(discriminator, _) => {
            discriminator match {
              case Some("user") => js.validate[io.flow.common.v0.models.User]
              case Some("user_reference") => js.validate[io.flow.common.v0.models.UserReference]
              case Some(other) => play.api.libs.json.JsSuccess(io.flow.common.v0.models.ExpandableUserUndefinedType(other))
              case None => sys.error("Union[ExpandableUser] requires a discriminator named 'discriminator' - this field was not found in the Json Value")
            }
          }
        }
      }
