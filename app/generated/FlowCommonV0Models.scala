 ...
 * apidoc:0.11.32 http://localhost:9000/flow/common/0.0.47/play_2_x_json
 */
package io.flow.common.v0.models {
  ...
  case class Organization(
    ...
    master: _root_.scala.Option[io.flow.common.v0.models.OrganizationReference] = None
  ...
  package object json {
    ...
    implicit def jsonReadsCommonOrganization: play.api.libs.json.Reads[Organization] = {
      (
        ...
        (__ \ "master").readNullable[io.flow.common.v0.models.OrganizationReference]
    ...
    def jsObjectOrganization(obj: io.flow.common.v0.models.Organization) = {
      play.api.libs.json.Json.obj(
        ...
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("master" -> jsObjectOrganizationReference(x))
      })
    }
