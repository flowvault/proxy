 ...
 * apidoc:0.11.32 http://localhost:9000/flow/organization/0.0.47/play_2_4_client
 */
package io.flow.organization.v0.models {
  ...
  /**
   * Data used to authorize a given user to access information for a given
   * organization
   */
  case class OrganizationAuthorizationForm(
    ...
    masterId: _root_.scala.Option[String] = None
  )
  ...
  package object json {
    ...
    implicit def jsonReadsOrganizationOrganizationAuthorizationForm: play.api.libs.json.Reads[OrganizationAuthorizationForm] = {
      (
        ...
        (__ \ "master_id").readNullable[String]
    ...
    def jsObjectOrganizationAuthorizationForm(obj: io.flow.organization.v0.models.OrganizationAuthorizationForm) = {
      ...
      (obj.masterId match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("master_id" -> play.api.libs.json.JsString(x))
      })
    }
...
package io.flow.organization.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.11.32 http://localhost:9000/flow/organization/0.0.47/play_2_4_client"
    val Version = "0.0.47"
    val VersionMajor = 0
  ...
  class Client(
    ...
    object Invitations extends Invitations {
      ...
      override def post(
        ...
        _executeRequest("POST", s"/invitations", body = Some(payload), requestHeaders = requestHeaders).map {
          ...
          case r if r.status == 401 => throw new io.flow.organization.v0.errors.UnitResponse(r.status)
          case r if r.status == 422 => throw new io.flow.organization.v0.errors.ErrorsResponse(r)
    ...
    object Organizations extends Organizations {
      override def get(
        ...
        name: _root_.scala.Option[String] = None,
        environment: _root_.scala.Option[io.flow.common.v0.models.Environment] = None,
        master: _root_.scala.Option[String] = None,
        limit: Long = 25,
        offset: Long = 0,
        sort: String = "name",
        requestHeaders: Seq[(String, String)] = Nil
  ...
  package errors {
    ...
    case class ErrorsResponse(
      ...
      lazy val errors = _root_.io.flow.organization.v0.Client.parseJson("Seq[io.flow.common.v0.models.Error]", response, _.validate[Seq[io.flow.common.v0.models.Error]])
    }
