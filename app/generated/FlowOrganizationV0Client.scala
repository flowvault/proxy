 ...
 * apibuilder:0.12.16 https://app.apibuilder.io/flow/organization/0.3.47/play_2_5_client
 */
package io.flow.organization.v0.models {
  ...
  object InvitationErrorCode {
     ...
     * above.
     */
    val all = Seq(Expired, InvalidEmail)
...
package io.flow.organization.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder:0.12.16 https://app.apibuilder.io/flow/organization/0.3.47/play_2_5_client"
    val Version = "0.3.47"
    val VersionMajor = 0
