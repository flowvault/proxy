 ...
 * apibuilder-0.13.0 https://app.apibuilder.io/flow/session/0.4.50/play_2_6_client
 */
package io.flow.session.v0.models {
  ...
  case class SessionCurrencyFormat(
...
package io.flow.session.v0.models {
  ...
  package object json {
    ...
    implicit def jsonReadsSessionSessionCurrencyFormat: play.api.libs.json.Reads[SessionCurrencyFormat] = {
      (
        (__ \ "symbol").read[io.flow.common.v0.models.CurrencySymbolFormat] and
        (__ \ "label_formatters").read[Seq[io.flow.common.v0.models.CurrencyLabelFormatter]]
      )(SessionCurrencyFormat.apply _)
    }
...
package io.flow.session.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder-0.13.0 https://app.apibuilder.io/flow/session/0.4.50/play_2_6_client"
    val Version = "0.4.50"
    val VersionMajor = 0
