 ...
 * apibuilder 0.14.59 app.apibuilder.io/flow/session/0.7.22/play_2_6_client
 */
  ...
  package object json {
    ...
    implicit def jsonReadsSessionOrganizationSession: play.api.libs.json.Reads[OrganizationSession] = {
      for {
        ...
        experiment <- (__ \ "experiment").readNullable[io.flow.session.v0.models.SessionExperiment]
      } yield OrganizationSession(id, organization, visitor, visit, environment, attributes, ip, local, geo, experience, format, experiment)
    }
...
package io.flow.session.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.14.59 app.apibuilder.io/flow/session/0.7.22/play_2_6_client"
    val Version = "0.7.22"
    val VersionMajor = 0
