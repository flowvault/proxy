 ...
 * apibuilder:0.12.16 https://app.apibuilder.io/flow/session/0.3.46/play_2_5_client
 */
...
package io.flow.session.v0.models {
  ...
  package object json {
    ...
    import io.flow.experiment.v0.models.json._
      ...
      def reads(js: play.api.libs.json.JsValue): play.api.libs.json.JsResult[Session] = {
        (js \ "discriminator").validateOpt[String] match {
          ...
          case play.api.libs.json.JsSuccess(discriminator, _) => {
            discriminator match {
              case Some("organization_session") => js.validate[io.flow.session.v0.models.OrganizationSession]
              case Some(other) => play.api.libs.json.JsSuccess(io.flow.session.v0.models.SessionUndefinedType(other))
              case None => sys.error("Union[Session] requires a discriminator named 'discriminator' - this field was not found in the Json Value")
            }
          }
        }
      }
    ...
    implicit def jsonReadsSessionSessionAuthorization: play.api.libs.json.Reads[SessionAuthorization] = new play.api.libs.json.Reads[SessionAuthorization] {
      def reads(js: play.api.libs.json.JsValue): play.api.libs.json.JsResult[SessionAuthorization] = {
        (js \ "discriminator").validateOpt[String] match {
          ...
          case play.api.libs.json.JsSuccess(discriminator, _) => {
            discriminator match {
              case Some("organization_session_authorization") => js.validate[io.flow.session.v0.models.OrganizationSessionAuthorization]
              case Some(other) => play.api.libs.json.JsSuccess(io.flow.session.v0.models.SessionAuthorizationUndefinedType(other))
              case None => sys.error("Union[SessionAuthorization] requires a discriminator named 'discriminator' - this field was not found in the Json Value")
            }
          }
        }
      }
...
package io.flow.session.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder:0.12.16 https://app.apibuilder.io/flow/session/0.3.46/play_2_5_client"
    val Version = "0.3.46"
    val VersionMajor = 0
