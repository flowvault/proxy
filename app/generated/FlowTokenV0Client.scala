 ...
 * apibuilder:0.12.52 https://app.apibuilder.io/flow/token/0.3.47/play_2_5_client
 */
  ...
  package object json {
    ...
    implicit def jsonReadsTokenTokenForm: play.api.libs.json.Reads[TokenForm] = new play.api.libs.json.Reads[TokenForm] {
      def reads(js: play.api.libs.json.JsValue): play.api.libs.json.JsResult[TokenForm] = {
        (js \ "discriminator").asOpt[String].getOrElse { sys.error("Union[TokenForm] requires a discriminator named 'discriminator' - this field was not found in the Json Value") } match {
...
package io.flow.token.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder:0.12.52 https://app.apibuilder.io/flow/token/0.3.47/play_2_5_client"
    val Version = "0.3.47"
    val VersionMajor = 0
