 ...
 * apibuilder:0.12.16 https://app.apibuilder.io/flow/token/0.3.47/play_2_5_client
 */
package io.flow.token.v0.models {
  ...
  object TokenDiscriminator {
    ...
    val all = Seq(OrganizationToken, PartnerToken)
  ...
  sealed trait TokenForm extends _root_.scala.Product with _root_.scala.Serializable

  /**
   * Defines the valid discriminator values for the type TokenForm
   */
  sealed trait TokenFormDiscriminator extends _root_.scala.Product with _root_.scala.Serializable

  object TokenFormDiscriminator {

    case object OrganizationTokenForm extends TokenFormDiscriminator { override def toString = "organization_token_form" }
    case object PartnerTokenForm extends TokenFormDiscriminator { override def toString = "partner_token_form" }

    case class UNDEFINED(override val toString: String) extends TokenFormDiscriminator

    val all = Seq(OrganizationTokenForm, PartnerTokenForm)

    private[this] val byName = all.map(x => x.toString.toLowerCase -> x).toMap

    def apply(value: String): TokenFormDiscriminator = fromString(value).getOrElse(UNDEFINED(value))

    def fromString(value: String): _root_.scala.Option[TokenFormDiscriminator] = byName.get(value.toLowerCase)
  ...
  object TokenReferenceDiscriminator {
    ...
    val all = Seq(OrganizationTokenReference, PartnerTokenReference)
...
package io.flow.token.v0.models {
  ...
  package object json {
      ...
      def reads(js: play.api.libs.json.JsValue): play.api.libs.json.JsResult[Token] = {
        (js \ "discriminator").validateOpt[String] match {
          ...
          case play.api.libs.json.JsSuccess(discriminator, _) => {
            discriminator match {
              case Some("organization_token") => js.validate[io.flow.token.v0.models.OrganizationToken]
              case Some("partner_token") => js.validate[io.flow.token.v0.models.PartnerToken]
              case Some(other) => play.api.libs.json.JsSuccess(io.flow.token.v0.models.TokenUndefinedType(other))
              case None => sys.error("Union[Token] requires a discriminator named 'discriminator' - this field was not found in the Json Value")
            }
          }
        }
      }
    ...
    implicit def jsonReadsTokenTokenForm: play.api.libs.json.Reads[TokenForm] = new play.api.libs.json.Reads[TokenForm] {
      def reads(js: play.api.libs.json.JsValue): play.api.libs.json.JsResult[TokenForm] = {
        (js \ "discriminator").validateOpt[String] match {
          ...
          case play.api.libs.json.JsSuccess(discriminator, _) => {
            discriminator match {
              case Some("organization_token_form") => js.validate[io.flow.token.v0.models.OrganizationTokenForm]
              case Some("partner_token_form") => js.validate[io.flow.token.v0.models.PartnerTokenForm]
              case Some(other) => play.api.libs.json.JsSuccess(io.flow.token.v0.models.TokenFormUndefinedType(other))
              case None => sys.error("Union[TokenForm] requires a discriminator named 'discriminator' - this field was not found in the Json Value")
            }
          }
        }
      }
    ...
    def jsObjectTokenForm(obj: io.flow.token.v0.models.TokenForm): play.api.libs.json.JsObject = {
      obj match {
    ...
    implicit def jsonReadsTokenTokenReference: play.api.libs.json.Reads[TokenReference] = new play.api.libs.json.Reads[TokenReference] {
      def reads(js: play.api.libs.json.JsValue): play.api.libs.json.JsResult[TokenReference] = {
        (js \ "discriminator").validateOpt[String] match {
          ...
          case play.api.libs.json.JsSuccess(discriminator, _) => {
            discriminator match {
              case Some("organization_token_reference") => js.validate[io.flow.token.v0.models.OrganizationTokenReference]
              case Some("partner_token_reference") => js.validate[io.flow.token.v0.models.PartnerTokenReference]
              case Some(other) => play.api.libs.json.JsSuccess(io.flow.token.v0.models.TokenReferenceUndefinedType(other))
              case None => sys.error("Union[TokenReference] requires a discriminator named 'discriminator' - this field was not found in the Json Value")
            }
          }
        }
      }
...
package io.flow.token.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder:0.12.16 https://app.apibuilder.io/flow/token/0.3.47/play_2_5_client"
    val Version = "0.3.47"
    val VersionMajor = 0
