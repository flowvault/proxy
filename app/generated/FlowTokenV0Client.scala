 ...
 * apidoc:0.11.32 http://localhost:9000/flow/token/0.0.47/play_2_4_client
 */
...
package io.flow.token.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.11.32 http://localhost:9000/flow/token/0.0.47/play_2_4_client"
    val Version = "0.0.47"
    val VersionMajor = 0
