 ...
 * apidoc:0.11.72 http://www.apidoc.me/flow/session-internal/0.1.20/play_2_5_client
 */
...
package io.flow.session.internal.v0.models {
  ...
  package object json {
    ...
    implicit def jsonReadsSessionInternalOrganizationSessionAuthorization: play.api.libs.json.Reads[OrganizationSessionAuthorization] = {
      (
        (__ \ "organization").read[String] and
    ...
    def jsObjectOrganizationSessionAuthorization(obj: io.flow.session.internal.v0.models.OrganizationSessionAuthorization) = {
      play.api.libs.json.Json.obj(
        "organization" -> play.api.libs.json.JsString(obj.organization),
    ...
    implicit def jsonReadsSessionInternalSessionAuthorizationForm: play.api.libs.json.Reads[SessionAuthorizationForm] = {
      (__ \ "session").read[String].map { x => new SessionAuthorizationForm(session = x) }
    }

    def jsObjectSessionAuthorizationForm(obj: io.flow.session.internal.v0.models.SessionAuthorizationForm) = {
      play.api.libs.json.Json.obj(
        "session" -> play.api.libs.json.JsString(obj.session)
      )
    }

    implicit def jsonWritesSessionInternalSessionAuthorizationForm: play.api.libs.json.Writes[SessionAuthorizationForm] = {
      new play.api.libs.json.Writes[io.flow.session.internal.v0.models.SessionAuthorizationForm] {
        def writes(obj: io.flow.session.internal.v0.models.SessionAuthorizationForm) = {
    ...
    implicit def jsonReadsSessionInternalSessionAuthorization: play.api.libs.json.Reads[SessionAuthorization] = new play.api.libs.json.Reads[SessionAuthorization] {
      def reads(js: play.api.libs.json.JsValue): play.api.libs.json.JsResult[SessionAuthorization] = {
        (js \ "discriminator").validate[String] match {
          case play.api.libs.json.JsError(msg) => play.api.libs.json.JsError(msg)
          case play.api.libs.json.JsSuccess(discriminator, _) => {
            discriminator match {
              case "organization_session_authorization" => js.validate[io.flow.session.internal.v0.models.OrganizationSessionAuthorization]
              case other => play.api.libs.json.JsSuccess(io.flow.session.internal.v0.models.SessionAuthorizationUndefinedType(other))
            }
          }
        }
      }
    ...
    def jsObjectSessionAuthorization(obj: io.flow.session.internal.v0.models.SessionAuthorization) = {
      obj match {
        case x: io.flow.session.internal.v0.models.OrganizationSessionAuthorization => jsObjectOrganizationSessionAuthorization(x) ++ play.api.libs.json.Json.obj("discriminator" -> "organization_session_authorization")
        case other => {
          sys.error(s"The type[${other.getClass.getName}] has no JSON writer")
        }
      }
    ...
    implicit def jsonWritesSessionInternalSessionAuthorization: play.api.libs.json.Writes[SessionAuthorization] = {
      new play.api.libs.json.Writes[io.flow.session.internal.v0.models.SessionAuthorization] {
        def writes(obj: io.flow.session.internal.v0.models.SessionAuthorization) = {
...
package io.flow.session.internal.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.11.72 http://www.apidoc.me/flow/session-internal/0.1.20/play_2_5_client"
    val Version = "0.1.20"
    val VersionMajor = 0
    ...
    object Sessions extends Sessions {
      override def getBySession(
        ...
        _executeRequest("GET", s"/sessions/${play.utils.UriEncoding.encodePathSegment(session, "UTF-8")}", requestHeaders = requestHeaders).map {
          ...
          case r => throw new io.flow.session.internal.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 200, 404")
        }
      }
      ...
      override def post(
        ...
        _executeRequest("POST", s"/sessions", body = Some(payload), requestHeaders = requestHeaders).map {
          case r if r.status == 201 => _root_.io.flow.session.internal.v0.Client.parseJson("io.flow.session.internal.v0.models.Session", r, _.validate[io.flow.session.internal.v0.models.Session])
          case r if r.status == 422 => throw new io.flow.session.internal.v0.errors.GenericErrorResponse(r)
          case r => throw new io.flow.session.internal.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 201, 422")
        }
      }
  ...
  package interfaces {
    ...
    trait Client {
      def baseUrl: String
      def sessionAuthorizations: io.flow.session.internal.v0.SessionAuthorizations
